...
class SoundPlay:
    game_bgm = "resource/sound/GameSceneBGM.ogg"
    world_bgm = 'resource/sound/WorldSceneBGM.ogg'
    eliminate = (
        'resource/sound/eliminate1.ogg',
        'resource/sound/eliminate2.ogg',
        'resource/sound/eliminate3.ogg',
        'resource/sound/eliminate4.ogg',
        'resource/sound/eliminate5.ogg'
    )  # 消除声音
    score_level = (
        'resource/sound/good.ogg',
        'resource/sound/great.ogg', 'resource/sound/amazing.ogg',
        'resource/sound/excellent.ogg',
        'resource/sound/unbelievable.ogg'
    )  # 得分声音
    click = "resource/sound/click.bubble.ogg"  # 点击选中声音
    board_sound = 'resource/sound/board.ogg'  # 落板子声音
    click_button = 'resource/sound/click_common_button.ogg'  # 点击按钮声音
    money_sound = 'resource/sound/money.ogg'  # 点击银币声音
    ice_break = 'resource/sound/ice_break.ogg'  # 冰消除声音
...
class Tree(pygame.sprite.Sprite):
    """树类"""
    tree = 'resource/images/tree.png'  # 树
    fruit = 'resource/images/fruit.png'  # 果子
    energy_num = 'resource/images/energy_num.png'  # 精力
    money = 'resource/images/money.png'  # 银币
    energy_buy = 'resource/images/energy_buy.png'  # 购买精力
    x, y = 340, 510
    h = 90
    position = (
        [x, y], [x + 50, y - 25],
        [x + 105, y - 45], [x - 5, y - h - 5],
        [x + 55, y - 25 - h + 10],
        [x + 105, y - 45 - h],
        [x, y - h * 2], [x + 50 + 10, y - 25 - h * 2 - 5], [x + 105 + 25, y - 45 - h * 2 - 14],
        [x + 30, y - h * 3 - 30]
    )  # 果子坐标组
            ...
            if level == 0:
                if self.type == 0:  # 树界面
                    ...
                    if Tree.energy_num_position[0] < mouse_down_x < Tree.energy_num_position[0] + 60 \
                            and Tree.energy_num_position[1] - 60 < mouse_down_y < Tree.energy_num_position[
                        1]:  # 精力60*60
...
class Element(pygame.sprite.Sprite):
    ...
    # 图标元组，包括6个小动物，
    animal = (
        'resource/images/fox.png',
        'resource/images/bear.png',
        'resource/images/chick.png',
        'resource/images/eagle.png',
        'resource/images/frog.png',
        'resource/images/cow.png'
    )
    ice = 'resource/images/ice.png'  # 冰层
    brick = 'resource/images/brick.png'  # 砖
    frame = 'resource/images/frame.png'  # 选中框
    bling = (
        "resource/images/bling1.png", "resource/images/bling2.png", "resource/images/bling3.png",
        "resource/images/bling4.png",
        "resource/images/bling5.png",
        "resource/images/bling6.png", "resource/images/bling7.png", "resource/images/bling8.png",
        "resource/images/bling9.png"
    )  # 消除动画

    ice_eli = (
        'resource/images/ice0.png', 'resource/images/ice1.png',
        'resource/images/ice2.png', 'resource/images/ice3.png', 'resource/images/ice4.png',
        'resource/images/ice5.png',
        'resource/images/ice6.png', 'resource/images/ice7.png', 'resource/images/ice8.png'
    )  # 消除冰块动画

    # 得分图片
    score_level = (
        'resource/images/good.png',
        'resource/images/great.png',
        'resource/images/amazing.png',
        'resource/images/excellent.png',
        'resource/images/unbelievable.png'
    )
    none_animal = 'resource/images/noneanimal.png'  # 无可消除小动物
    stop = 'resource/images/exit.png'  # 暂停键
...
class Board(pygame.sprite.Sprite):
    step_board = 'resource/images/step.png'  # 剩余步数板子
    step = (
        'resource/images/0.png', 'resource/images/1.png',
        'resource/images/2.png', 'resource/images/3.png',
        'resource/images/4.png', 'resource/images/5.png',
        'resource/images/6.png', 'resource/images/7.png', 'resource/images/8.png',
        'resource/images/9.png',
    )
    task_board = 'resource/images/task.png'  # 任务板子
    ok = 'resource/images/ok.png'  # ok勾
    # 关数板子
    levelBoard = (
        'resource/images/level0.png', 'resource/images/level1.png', 'resource/images/level2.png',
        'resource/images/level3.png', 'resource/images/level4.png',
        'resource/images/level5.png',
        'resource/images/level6.png',
        'resource/images/level7.png', 'resource/images/level8.png',
        'resource/images/level9.png',
        'resource/images/level10.png'
    )
    # xxx = 'resource/images/x.png'   # 叉掉
    test = 'resource/images/test.png'
    success_board = 'resource/images/successtest1.png'  # 过关成功板子
    fail_board = 'resource/images/failBoard.png'  # 任务失败
    step_add = 'resource/images/step_add.png'  # 增加步数
    next = "resource/images/next.png"  # 下一关按钮
    replay = "resource/images/replay.png"  # 重玩图片
    stars = 'resource/images/startest.png'  # 星星图片
    money = 'resource/images/money.png'  # 银币
    energy = 'resource/images/energ.png'  # 精力
...
class Manager:
    ...
    screen = pygame.display.set_mode(__screen_size, DOUBLEBUF, 32)
    __brick_size = 50
    __bg = pygame.image.load('resource/images/bg.png').convert()
    stop_width = 63
    ...
    def mouse_image(self):
        """"  更换鼠标图片 """
        mouse_cursor = pygame.image.load('resource/images/mouse.png').convert_alpha()
                ...
                if self.list_x < mouse_down_x < self.list_x + Manager.__brick_size * self.width \
                    ...
                    if self.animal[mouse_selected[0]][mouse_selected[1]] != -1:
                        ...
                        if (self.last_sel[0] == self.selected[0] and abs(self.last_sel[1] - self.selected[1]) == 1) \
                                or (
                                self.last_sel[1] == self.selected[1] and abs(self.last_sel[0] - self.selected[0]) == 1):
